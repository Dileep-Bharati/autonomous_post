    ...
    for country, params in countries_rss.items():
        try:
            ...
            if len(items) >= 2:
                ...
                top_1 = items[0].text.rsplit(' - ', 1)[0]
                top_2 = items[1].text.rsplit(' - ', 1)[0]
                global_topics.add(top_1)
                global_topics.add(top_2)
